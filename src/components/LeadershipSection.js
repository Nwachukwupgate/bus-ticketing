    ...
    return (
      <div className="py-20">
        <div className="px-6 md:px-12">
          <div className="mb-28">
            <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 dark:text-white md:text-4xl lg:text-6xl">
              Campus Connect
            </h2>
            <p className="text-center text-gray-600 dark:text-gray-300 lg:mx-auto lg:w-8/12 text-sm md:text-lg lg:text-2xl">
